...
const CustomPaginationActionsTable = ({ data }: { data: getdatatype[] }) => {
...
const SecondTable = () => {
  ...
  useEffect(() => {
    ...
    if (!userdata) {
      ...
      return; // Add return to prevent further execution if user data is not available
    }
